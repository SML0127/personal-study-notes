...
- 자기소개
- 개발한 시스템 관련 
  - 개발한 시스템의 전체적인 동작과정 질문            
  - 데모 영상을 보며 설명 요청 질문         
  - web ui 형태에서 extension으로 바꾼 이유에 대한 질문

- 협업 관련
  - 내가 작성한 코드를 남이 못알아 볼수 있지 않은지에 대한 질문
  - 코딩 스타일, 포맷, 가이드라인, 템플릿을 잘 맞춘다고 남이 알아 볼 수 있다 생각하는지 질문
  - 내가 작성한 코드를 남이 못알아 본 경우, 경험에 대한 질문
  - git에 있는 코드들을 보며 어떻게 고치면 좋을지 질문
  - 코드들에 대해 고쳐야할 생각을 하였지만 못한건지, 아니면 생각을 하지 않은건지 질문
  - 

- 인성 관련
  - 개발자로써 바라는 N년후의 나의 모습        
  - 입사 후 하고 싶은 일이나 업무              

- 기타 
  - 구현으로 논문이 될 수 있는지 질문 
  - 코딩테스트 난이도 어땠는지 질문
  - 코딩테스트 마지막 문제 어떻게 접근했는지 질문 (논리적 추론을 바로 했는지)
  - 본인의 알고리즘 실력은 어느 정도 된다고 생각하는지 질문

셀프 피드백
- 협업, 그 중에서도 코드 리뷰와 관련 질문들이 다수 (1차 면접의 피드백이던듯)
- 1차 면접이 'What', 'How'에 초점을 맞추었다면, 2차는 'Why'를 많이       
